...
class API():
    ...
    def add_id_to_cache(self, new_id, userid, path):
        ...
        if userid in data:
            ...
            id_list = id_list[:10]
            data[userid]["id_quest_battle"] = {f"id_{i+1}": v for i, v in enumerate(id_list)}
    ...
    """░█████╗░░█████╗░██╗░░░░░██╗░░░░░  ██████╗░░█████╗░████████╗
        ...
        ╚█████╔╝██║░░██║███████╗███████╗  ██████╦╝╚█████╔╝░░░██║░░░
        ░╚════╝░╚═╝░░╚═╝╚══════╝╚══════╝  ╚═════╝░░╚════╝░░░░╚═╝░░░"""
    def catpcha_recover(self, token, group, tokentype, channelid, dmchannelid, userid, username):
        time.sleep(2)
        ...
        pass
    def run__bot__captcha(self, token, group, tokentype, channelid, dmchannelid, userid, username):
        while True:            
            try: 
                response = requests.get(
                    f"https://discord.com/api/v9/channels/{channelid}/messages?limit=10",
